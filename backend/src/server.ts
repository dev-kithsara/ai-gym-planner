...
import cors from 'cors'; // CORS කියන්නේ Cross-Origin Resource Sharing. මේකෙන් අපේ backend එකට වෙන domain එකකින් (උදාහරණයක් වශයෙන්, React frontend එකක්) එන ඉල්ලීම් (requests) වලට අවසර දෙනවා.
import userRoutes from './routes/userRoutes'; // අලුතින් හදපු Route එක Import කරගත්තා
import workoutRoutes from './routes/workoutRoutes'; // අලුතින් හදපු Workout Route එක Import කරගත්තා 
...
// Middleware
app.use(cors()); // 👈 React එකට කතා කරන්න අවසර දුන්නා
app.use(express.json());// JSON දත්ත (ඒ කියන්නේ ඉස්සරහට React frontend එකෙන් එවන දත්ත) කියවන්න server එකට උගන්වන්න ඕනේ. ඒකට තමයි මේ middleware එක පාවිච්චි කරන්නේ. මේක නැත්නම් frontend එකෙන් එවන දේවල් backend එකට තේරෙන්නේ නෑ.
